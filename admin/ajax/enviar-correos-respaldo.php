...
if($sucursal!=''){
    $addSucursal=" AND  sucursal='".$sucursal."'";
}else{
    $addSucursal='';
}

$con="SELECT
clientes_correos_contratos.id_tipo_correo
, clientes_correos.nombre
, clientes_correos.titulo
, clientes_correos.correo
, clientes_correos.sucursal
FROM
clientes_correos_contratos
INNER JOIN clientes_correos 
    ON (clientes_correos_contratos.id_correo = clientes_correos.id) WHERE clientes_correos.id=".$cliente_id." 
".$addSucursal." ";
...
foreach($rs as $v=>$val){
    ...
    <h3 style="margin-top:0cm;box-sizing:border-box" align="right"><span style="font-size:13.5pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:#3d4852">Fecha de alta contrato: '.$fecha_alta.'<br></span></h3>
    ...
    <span style="font-size:12.0pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:black">'.$suceso.'. <br> Se solicita el apoyo para visto bueno del documento adjunto.</span></p><p style="margin-top:0cm;line-height:18.0pt;box-sizing:border-box">
    <span style="font-size:12.0pt;font-family:&quot;Segoe UI&quot;,sans-serif;color:black"><br></span><span style="font-size:12.0pt;font-family:&quot;Segoe UI&quot;,sans-serif"><u></u><u></u></span>
    </p><p>Descripci&oacute;n: '.$descripcion_contrato.'</p>
    <p></p>
    <div align="center">
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('notify@mustango.com.mx', 'Contrato Folio: '.$folio);
    ...
    */    
        if($archivo!=''){
            foreach($archivo as $file){    
                if($file!=''){
                    $mail->addAttachment('../../documentos/contratos/'.$file); 
                }
            }
        }
        //Attachments
    ...
    //    $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
        ...
        $mail->Subject = 'Contrato Folio: '.$folio;
        $mail->Body    = $mensaje;
        $mail->CharSet = 'UTF-8';
