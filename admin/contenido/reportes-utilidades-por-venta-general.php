<?php // contenido/reportes-utilidades-por-venta-general.php 
?>
<div class="ms-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Utilidades por Venta (General)</li>
        </ol>
    </nav>
</div>
...
<script>
    $(function() {
        const t = $('#tabla').DataTable({
            ...
            processing: true,
            ajax: {
                url: 'ajax/reportes/tabla-utilidades-por-venta-general.php',
                type: 'POST',
                data: function(d) {
                    d.f_ini = $('#f_ini').val();
                    d.f_fin = $('#f_fin').val();
