                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row col-12">
                            <div class="col-8">
                                <button type="button" class="btn btn-secondary" onclick="fnModalAltas();"> <i class="fas fa-plus"></i> Agregar unidad de medida</button>
                            </div>
                            <div class="col-4">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tablaUdeM" class="table table-bordered table-striped">
                            <thead>
                                <tr>
...
<script>
            ...
            function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var table = $('#tablaUdeM').DataTable();
                        table.ajax.reload(function(json) {
                            $('#tablaUdeM').val(json.lastInput);
                        });
                    }
                }); /* End ajax */
    ...
    $(document).ready(function() {
        ...
        var oTable = $('#tablaUdeM').DataTable();
