<?php
$con = "SELECT * FROM cat_proveedores WHERE id=" . $cat;
                        ...
                        <div class="row g-3">
                            ...
                            <div class="form-group">
                                <div class="form-outline">
                                    <input type="text" name="razonSocial" id="razonSocial" class="form-control" value="<?= $razon_social; ?>" />
                            ...
                            <div class="form-group">
                                <div class="form-outline">
                                    <input type="text" name="nombreComercial" id="nombreComercial" class="form-control" value="<?= $nombre_Comercial; ?>" />
                            ...
                            <div>
                                <div class="row g-3">
                                    <div class="form-group col-12 col-md-4">
                                        <div class="form-outline">
                                            <input type="text" name="telefono" id="telefono" class="form-control" value="<?= $tel; ?>" />
                            ...
                            <div>
                                <div class="row g-3">
                                    <div class="form-group col-12 col-md-6">
                                        <div class="form-outline">
                                            <input type="text" name="numExt" id="numExt" class="form-control" value="<?= $num_ext; ?>" />
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        <div class="form-outline">
                                            <input type="text" name="numInt" id="numInt" class="form-control" value="<?= $num_int; ?>" />
                                ...
                                <div class="row g-3">
                                    <div class="form-group col-12 col-md-3">
                                        <div class="form-outline" data-mdb-input-init>
                                            <input type="text" id="cp" list="cplist" name="cp" class="form-control" onblur="fnColonias();" autocomplete="off" value="<?= $cp; ?>" />
                                    ...
                                    <div class="form-group col-12 col-md-9">
                                        <div class="form-outline" data-mdb-input-init>
                                            <input type="text" id="colonia" list="colonialist" name="colonia" class="form-control" autocomplete="off" value="<?= $colonia; ?>" />
                            ...
                            <div>
                                <div class="row g-3">
                                    <div class="form-group col-12 col-md-4">
                                        <div class="form-outline">
                                            <input type="text" name="telContacto" id="telContacto" class="form-control" value="<?= $tel_contacto; ?>" />
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        <div class="form-outline">
                                            <input type="text" name="contacto" id="contacto" class="form-control" value="<?= $contacto; ?>" />
                            ...
                            <div class="form-group">
                                <div class="form-outline">
                                    <input type="text" name="mapa" id="mapa" class="form-control" oninput="this.value = this.value.toLowerCase();" value="<?= $mapa; ?>" />
            ...
            submitHandler: function(form) {
                alertify.confirm('Aviso..!', '¿Deseas guardar los datos?',
                    function() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "ajax/proveedores/modificar.php",
                            data: datos,
                            success: function(data) {
                                console.log(data);
                                if (data == 1) {
