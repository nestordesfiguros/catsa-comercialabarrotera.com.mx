<?php
// admin/contenido/clientes-altas.php
// Empresa actual
$idEmpresa = 0;
...
// Tomar nombres desde algún producto de la empresa (por almacén -> empresa)
if ($idEmpresa > 0) {
    $sql = "
        SELECT
    ...
    if ($clsConsulta->numrows > 0) {
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            // Si viene vacío / NULL / o valor por defecto (precio01, precio02, etc.) => "Lista X"
            ...
            <div class="d-flex justify-content-center align-items-center w-100">
                <div class="card col-12 col-lg-9 col-xl-8">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">
                            <i class="fa fa-user-plus me-2"></i>Alta de Cliente
                        </h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Captura la información básica del cliente.</small>
                        </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-floating">
                                    <select id="lista_precios" name="lista_precios" class="form-select">
                                        ...
                                        <option value="1"><?php echo htmlspecialchars($listaNombres[1]); ?></option>
                                        <option value="2"><?php echo htmlspecialchars($listaNombres[2]); ?></option>
                                        <option value="3"><?php echo htmlspecialchars($listaNombres[3]); ?></option>
                                        <option value="4"><?php echo htmlspecialchars($listaNombres[4]); ?></option>
                                        <option value="5"><?php echo htmlspecialchars($listaNombres[5]); ?></option>
                                    </select>
                                    <label for="lista_precios">Lista de precios (opcional)</label>
                                </div>
                                <div class="form-text">Define el precio por defecto para este cliente (puede quedar sin asignar).</div>
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6 col-md-3">
                                <div class="form-floating">
                                    <input type="text" id="num_ext" name="num_ext" class="form-control" placeholder="No. Ext" />
                            ...
                            <div class="col-6 col-md-3">
                                <div class="form-floating">
                                    <input type="text" id="num_int" name="num_int" class="form-control" placeholder="No. Int" />
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-floating">
                                    <input type="text" id="cp" list="cplist" name="cp" class="form-control" placeholder="CP" onblur="fnColonias();" autocomplete="off" />
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-floating">
                                    <input type="text" id="colonia" list="colonialist" name="colonia" class="form-control" placeholder="Colonia" autocomplete="off" />
...
<script>
    ...
    // ====== Dependencias Estado/Municipio/CP/Colonias (mantengo flujo actual) ======
    ...
    $(document).ready(function() {
        ...
        $("#formClientes").validate({
            ...
            errorPlacement: function(error, element) {
                // En form-floating y selects, insertamos justo después
            ...
            submitHandler: function(form) {
                ...
                alertify.confirm(
                    ...
                    function() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "ajax/clientes/guarda-clientes.php",
                            data: datos,
