                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <div class="form-outline" data-mdb-input-init>
                                            <input type="date" id="fecha_alta" name="fecha_alta" class="form-control" value="<?php echo $fecha_alta; ?>" />
                                            <label class="form-label" for="fecha_alta">Fecha de ingreso (dd/mm/aaaa)</label>
                                        </div>
                                    </div>

                                    <div class="form-group col-6">
                                        <div class="form-outline" data-mdb-input-init>
                                            <input type="text" id="comision" name="comision" class="form-control" value="<?php echo $comision; ?>" />
                                            <label class="form-label" for="nombre">Porcentaje de Comision %</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <select name="id_estado" id="edo" class="form-select" data-mdb-select-init onchange="fnMunicipio();">
                                            ...
                                            $rs = $clsConsulta->consultaGeneral($con);
                                            foreach ($rs as $v => $val) {
                                                $estados=strtoupper($val['nombre']);
                                                if ($id_estado == $val['id']) {
                                                    echo '<option value="' . $val['id'] . '" selected >' . $estados . '</option>';
                                                } else {
                                                    echo '<option value="' . $val['id'] . '">' . $estados . '</option>';
                                                }
                                            }
                                            ?>
                                        </select>
