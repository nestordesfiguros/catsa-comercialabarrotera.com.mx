<?php
$con = "SELECT * FROM cat_categorias WHERE id_categoria=" . $cat;
...
<div class="ms-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> Sub Categorías de <?php echo $nombreCategoria; ?></li>
        </ol>
    </nav>
</div>
<!-- /.content-header -->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row col-12">
                            <div class="col-8">
                                <button type="button" class="btn btn-secondary" onclick="fnModalAltas();">Agregar Sub Categoría</button>
                            </div>
                            <div class="col-4">
    ...
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Agregar una Sub categoría</h5>
...
<script>
    ...
    function borrar(id) {
        alertify.confirm('Aviso..!', '¿Deseas Borrar la categoría?',
            function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajax/subcategorias/borrar.php",
                    data: {
                        "id": id
                    },
    ...
    $(document).ready(function() {
        ...
        $('#tablaCategorias').dataTable({
            ajax: "ajax/subcategorias/tabla_subcategorias.php?idCategoria=" + idCategoria,
            ordering: true,
            fixedHeader: false,
            ...
            submitHandler: function(form) {
                ...
                alertify.confirm('Aviso..!', '¿Deseas guardar la categoría?',
                    function() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "ajax/subcategorias/guardar.php",
                            data: datos,
                            success: function(data) {
            ...
            submitHandler: function(form) {
                ...
                alertify.confirm('Aviso..!', '¿Deseas modificar la categoría?',
                    function() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "ajax/subcategorias/modificar.php",
                            data: datos,
                            success: function(data) {
