...
<script>
    IMask(
        document.getElementById('comision'), {
            mask: '00.00'
        }
    )
    ...
    $(document).ready(function() {
        ...
        $("#formVendedores").validate({
            ...
            messages: {
                ...
                contacto: {
                    maxlength: "Debe de contener máximo 200 caracteres",
                    minlength: "Debe de contener por lo menos 10 caracteres"
                },
                telcontacto: {
                    maxlength: "Teléfono debe de contener 10 numeros",
                    minlength: "Teléfono debe de contener 10 numeros"
            ...
            submitHandler: function(form) {
                ...
                alertify.confirm('Aviso..!', '¿Deseas guardar los datos?',
                    function() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "ajax/vendedores/guardar.php",
                            data: datos,
                            success: function(data) {
                                console.log(data);
                                if (data == 1) {
