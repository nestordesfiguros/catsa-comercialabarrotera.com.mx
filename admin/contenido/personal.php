                    ...
                    <div class="card-header">
                        <div class="row col-12">
                            <div class="col-8">
                                ...
                                <a type="button" class="btn btn-info" href="personal-altas"><i class="fa fa-plus"></i> Agregar </a> &nbsp;
                            </div>
                            <div class="col-4">
...
<script type="text/javascript">
            ...
            success: function(data) {
                ...
                if (data == 1) {
                    ...
                    table.ajax.reload(function(json) {
                        $('#tablaPersonal').val(json.lastInput);
                    });
    ...
    function editar(id) {
        location.href = "personal-editar/" + id;
    };
    ...
    $(document).ready(function() {
        ...
        $('#tablaPersonal').dataTable({
            ajax: 'ajax/personal/tabla-personal.php',
            ordering: true,
            pageLength: 10,
        ...
        var oTable = $('#tablaPersonal').DataTable();
