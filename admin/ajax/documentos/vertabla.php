    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>                                  
                ...
                <th>¿Solicita Comentario?</th>
                <th>¿Es Multiple?</th>
                <th>¿Solicita Referencia?</th>
                <th>¿Programar Seguimiento?</th>
                <th>¿Permite Aplazamiento?</th>
                <th>Estatus</th>
                <th>Editar</th>
                <th>Deshabilitar</th>
            </tr>
        ...
        <tbody>
            <?php 
                ...
                foreach($rs as $v=>$val){
                    ...
                    echo '<td class="text-center"><a style="cursor:pointer" title="Deshabilitar" data-bs-toggle="modal" data-bs-target="#borrar" class="text-danger" onclick="funborrar('.$id.');"><i class="fas fa-trash fa-lg"></i></a></td>';
                    echo '</tr>';
                }
                ?>
        </tbody>
